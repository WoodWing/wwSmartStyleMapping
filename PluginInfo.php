...
class wwSmartStyleMapping_EnterprisePlugin extends EnterprisePlugin
{
	public function getPluginInfo()
	{ 
		require_once BASEDIR.'/server/interfaces/plugins/PluginInfoData.class.php';
		$info = new PluginInfoData(); 
		$info->DisplayName = 'wwSmartStyleMapping';
		$info->Version     = '2020.03.13'; // don't use PRODUCTVERSION
		$info->Description = 'Map pseude styles to layout styles after place, update, open';
