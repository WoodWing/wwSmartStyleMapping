...
// the InCopy User Scripts folder when a user with applicable access rights logs in 
// into Enterprise 
//
// This InCopy folder should contain all scripts (subfolders, such as 'Startup Scripts' 
